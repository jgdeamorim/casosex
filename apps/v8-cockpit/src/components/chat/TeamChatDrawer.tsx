...
export function TeamChatDrawer(): React.ReactElement | null {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { id: '1', channel: '#geral-volupia', author: 'Jeferson (Founder)', time: '10:14', text: 'Pessoal, atualizamos a lista para 405 fornecedores homologados!' },
  ...
  return (
    <div className="fixed inset-y-0 right-0 w-80 sm:w-96 bg-[#161214] border-l border-white/10 shadow-2xl z-50 flex flex-col justify-between animate-slideLeft">
      {/* Header */}
      <div className="p-4 border-b border-white/10 flex items-center justify-between bg-[#0c0a0b]">
        ...
        <button
          onClick={toggleChat}
          className="p-1 rounded-lg text-[#a39b94] hover:text-[#faf7f5] hover:bg-[#221c1f]"
        >
          ✕
        </button>
      </div>
