import { o as __toESM } from "./rolldown-runtime_BMI-E3GI.mjs";
import { a as normalizeMime } from "./hash-Cb7U1b5M_CHUcNDr6.mjs";
import { t as S } from "./dist_CHdF0ICT.mjs";
...
async function decodeJpeg(buffer) {
	const { decode } = await import("./jpeg-js_DrEr49gA.mjs").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
async function decodePng(buffer) {
	const UPNG = (await import("./UPNG_CQS7Wsl8.mjs").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).default;
