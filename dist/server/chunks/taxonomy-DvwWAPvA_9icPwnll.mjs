...
import { d as invalidateTaxonomyObjectCache } from "./object-cache-Bok5j2ae_D6Qn5mkk.mjs";
...
var TaxonomyRepository = class {
	...
	*/
	async countEntriesForTerms(translationGroups) {
		...
		const { chunks, SQL_BATCH_SIZE } = await import("./chunks-D5dlPeRb_BU7gTRu4.mjs").then((n) => n.r);
