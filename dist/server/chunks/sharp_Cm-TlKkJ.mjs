import { I as NoImageMetadata, P as MissingSharp, et as UnsupportedImageFormat, t as AstroError } from "./errors_CPRp8csy.mjs";
import { o as detector, r as parseQuality, s as resolveDefaultOutputFormat, t as baseService } from "./service_DzPQ2Ryn.mjs";
//#region node_modules/.pnpm/astro@7.2.1_@emnapi+core@1.11.1_@emnapi+runtime@1.11.3_@types+node@24.10.13_jiti@2.7.0_yaml@2.9.0/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./dist_DfOBIKyb.mjs")).default;
	} catch {
