import { C as string, _ as number, a as _enum, c as array, l as boolean, v as object } from "./schemas_CzTFUUcv.mjs";
import { i as encodeBase64urlNoPadding } from "./dist_CycaXRgm.mjs";
import { t as Role } from "./types-ndj-bYfi_CKu1x_5-.mjs";
import { p as hashToken, u as generateTokenWithHash } from "./passkey_eKvnpHNN.mjs";
import { n as sha256 } from "./sha2_Celbjg9f.mjs";
//#region self-essentials/emdash-main/packages/auth/dist/oauth/providers/github.mjs
/**
* GitHub OAuth provider
*/
var gitHubUserSchema = object({
	id: number(),
	login: string(),
...
//#endregion
//#region self-essentials/emdash-main/packages/auth/dist/oauth/providers/google.mjs
/**
* Google OAuth provider (using OIDC)
*/
var googleUserSchema = object({
	sub: string(),
	email: string(),
