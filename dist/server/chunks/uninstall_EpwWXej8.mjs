...
import { D as handleMarketplaceUninstall } from "./query-1xOcEy18_dGFoQgZT.mjs";
...
//#region self-essentials/emdash-main/packages/core/dist/astro/routes/api/admin/plugins/_id_/uninstall.mjs
var uninstall_exports = /* @__PURE__ */ __exportAll({
	POST: () => POST,
	prerender: () => false
});
var uninstallBodySchema = object({ deleteData: boolean().optional() });
...
//#endregion
//#region \0virtual:astro:page:self-essentials/emdash-main/packages/core/dist/astro/routes/api/admin/plugins/_id_/uninstall@_@mjs
