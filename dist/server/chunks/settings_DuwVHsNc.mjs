...
import { C as string, T as unknown, v as object, x as record } from "./schemas_CzTFUUcv.mjs";
...
import { H as handlePluginSettingsUpdate, V as handlePluginSettingsGet, r as getPluginSettingsSchema } from "./query-1xOcEy18_dGFoQgZT.mjs";
...
//#region self-essentials/emdash-main/packages/core/dist/astro/routes/api/admin/plugins/_id_/settings.mjs
var settings_exports = /* @__PURE__ */ __exportAll({
	GET: () => GET,
	PUT: () => PUT,
	prerender: () => false
});
var updateBody = object({ values: record(string(), unknown()) });
...
//#endregion
//#region \0virtual:astro:page:self-essentials/emdash-main/packages/core/dist/astro/routes/api/admin/plugins/_id_/settings@_@mjs
