...
class WC_Report_Sales_By_Supplier extends WC_Admin_Report
{
	...
	public function output_report() {
		...
		if (isset($_POST['export'])) {
			...
			$term_id = $_POST['term_id']; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
			$start_date = $_POST['start_date']; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
			$end_date = $_POST['end_date']; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
			...
			if ($the_query->have_posts()) {
				...
				while ($the_query->have_posts()) {
					...
					$order_billing_country = ! empty( $countries[ $order_billing_country ] ) ? $countries[ $order_billing_country ] : '';
		...
		echo wp_kses_post( $html ); // nosemgrep: scanner.php.lang.security.xss.unescaped-sanitized
	}
