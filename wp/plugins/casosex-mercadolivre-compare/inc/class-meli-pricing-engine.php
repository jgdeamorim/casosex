...
class CasoSex_MeLi_Pricing_Engine {
    ...
    public static function get_settings() {
        return [
            ...
            'target_margin_lp'   => floatval(get_option('casosex_target_margin_lp', 50.0)),
    ...
    /**
     * Calcula a precificação ideal para todos os 4 canais
     */
    public static function calculate_all_channels($cost_b2b, $box_units = 1, $meli_market_price = 0, $cpa_ads = 0) {
        ...
        // P = (Custo + Embalagem) / (1 - (Imposto + Gateway + Margem_Store))
        ...
        // 4. Canal: Landing Page de Conversão (lp.casosex.com.br) absorvendo CPA de Ads
        $effective_cpa = ($cpa_ads > 0) ? $cpa_ads : round($cost_b2b * 0.20, 2); // Default CPA estimado em 20% do custo
